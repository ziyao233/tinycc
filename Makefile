...
NATIVE_DEFINES_$(CONFIG_loongarch64) += -DTCC_TARGET_LOONGARCH64
...
DEF-loongarch64    = -DTCC_TARGET_LOONGARCH64
...
TCC_X += riscv64 arm64-osx loongarch64
...
TRIPLET-loongarch64 ?= loongarch64-linux-gnu
...
loongarch64_FILES = $(CORE_FILES) loongarch64-gen.c loongarch64-link.c
loongarch64_FILES += loongarch64-asm.c
